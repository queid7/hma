...
# keep position of element at startFrame during ys_motion[startFrame] ~ ys_motion[endFrame]
def fixPosition(motion, element_name_or_index, startFrame, endFrame, update=True):
    ...
    # keep during ys_motion[startFrame] ~ ys_motion[endFrame]

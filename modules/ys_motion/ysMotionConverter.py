...
def mm2Joint_Posture(pointPosture, pointTPose, jointSkeleton):
    ...
    extendedPoints = {}
    for jointName, joint in list(jointSkeleton.joints.items()):
...
def joint2mm_Skeleton(jointSkeleton):
    ...
    for name, joint in list(jointSkeleton.joints.items()):
        for childJoint in joint.children:
...
def joint2mm_Posture(jointPosture, pointSkeleton):
    ...
    for joint in list(jointPosture.skeleton.joints.values()):
...
#        pointMotion = pointMotion[0:1]
        ...
        print(list(pointMotion[0].pointMap.keys()))
        print('jointMotion.skeleton', list(jointMotion[0].skeleton.joints.keys()))
        print('pointMotion2.skeleton', pointMotion2[0].skeleton.links)
        print(list(pointMotion2[0].pointMap.keys()))

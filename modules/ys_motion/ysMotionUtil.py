...
#    import GUI.ysViewer2 as yv2
    ...
    def test_getAllParentIndexes(): 
        ...
        for i in range(len(masks)):
            print('parents of', skeleton.getElementName(i), ':', end=' ')
            for parent in masks[i]:
                print(skeleton.getElementName(parent), end=' ')
            print()
        print()
        ...
        print(masks)
        for i in range(len(masks)):
            print('parents of', skeleton.getJointName(i), ':', end=' ')
            for parent in masks[i]:
                print(skeleton.getJointName(parent), end=' ')
            print()
        print()

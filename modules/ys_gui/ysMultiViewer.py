...
#        print '[FRAMELOG]onFrame', frame
        if self.recording:
            if self.sceneStates1[frame] is None:
...
#    def addRenderer(self, name, ys_renderer, visible=True):
#        self.rendererNames.append(name)
#        self.rendererMap[name] = ys_renderer
...
#        for ys_renderer in self.rendererMap.values():
#            ys_renderer.selectedElement = element 
